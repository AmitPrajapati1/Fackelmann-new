...
<div class="container">
    <div class="header">Data Protection</div>
    <p class="text-muted">This Privacy Policy describes Our policies and procedures on the collection, use and
        disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law
        protects You.</p>
    <p class="text-muted">We use Your Personal data to provide and improve the Service. By using the Service, You agree
    ...
    <ul class="definition-list">
        ...
        <li><strong>Company</strong>
            <p>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Fackelmann Inda
                Kitchenware Pvt. Ltd., #315 - 3rd Floor, Part-II, JMD Pacific Square, Sector -15, Haryana, India.</p>
        </li>
        <li><strong>Cookies</strong>
            <p>are small files that are placed on Your computer, mobile device or any other device by a website,
                containing the details of Your browsing history on that website among its many uses.</p>
        </li>
        <li><strong>Country</strong>
            <p>refers to: Haryana, India.</p>
        </li>
        ...
        <li><strong>Service Provider</strong>
            <p>means any natural or legal person who processes the data on behalf of the Company. It refers to
        ...
        <li><strong>Third-party Social Media Service</strong>
            <p>refers to any website or any social network website through which a User can log in or create an account
                to use the Service.</p>
        </li>
        <li><strong>Usage Data</strong>
            <p>refers to data collected automatically, either generated by the use of the Service or from the Service
                infrastructure itself (for example, the duration of a page visit).</p>
        </li>
        <li><strong>Website</strong>
            <p>refers to Fackelmann India, accessible from Fackelmann.co.in.</p>
        </li>
        <li><strong>You</strong>
            <p>means the individual accessing or using the Service, or the company, or other legal entity on behalf of
                which such individual is accessing or using the Service, as applicable.</p>
        </li>
    </ul>

    <div class="section-title">Collecting and Using Your Personal Data</div>
    ...
    <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile
        ...
        learn more about cookies here: Cookies by TermsFeed Generator.</p>
    ...
    <ul class="definition-list">
        <li><strong>Necessary / Essential Cookies</strong>
            <ul class="subsection-list">
                ...
                <li><strong>Purpose:</strong> These Cookies are essential to provide You with services available through
                    the Website and to enable You to use some of its features. They help to authenticate users and
                    prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for
                    cannot be provided, and We only use these Cookies to provide You with those services.</li>
            </ul>
        </li>
        <li><strong>Cookies Policy / Notice Acceptance Cookies</strong>
            <ul class="subsection-list">
                ...
                <li><strong>Administered by:</strong> Us</li>
                <li><strong>Purpose:</strong> These Cookies identify if users have accepted the use of cookies on the
                    Website.</li>
            </ul>
        </li>
    ...
    <div class="section-title">Use of Your Personal Data</div>
    <p>The Company may use Personal Data for the following purposes:</p>
    <ul class="definition-list">
        <li>To provide and maintain our Service, including to monitor the usage of our Service.</li>
        <li>To manage Your Account: to manage Your registration as a user of the Service. The Personal Data You provide
            can give You access to different functionalities of the Service that are available to You as a registered
            user.</li>
        <li>For the performance of a contract: the development, compliance and undertaking of the purchase contract for
    ...
    <ul class="definition-list">
        <li>With Service Providers: We may share Your personal information with Service Providers to monitor and analyze
        ...
        <li>With other users: when You share personal information or otherwise interact in the public areas with other
            ...
            users will be able to view descriptions of Your activity, communicate with You and view Your profile.</li>
        <li>With Your consent: We may disclose Your personal information for any other purpose with Your consent.</li>
    </ul>

    <div class="section-title">Retention of Your Personal Data</div>
    ...
    <div class="section-title">Transfer of Your Personal Data</div>
    ...
    <div class="section-title">Disclosure of Your Personal Data</div>
    ...
    <div class="section-title">Security of Your Personal Data</div>
    ...
    <ul class="definition-list">
        <li>By visiting this page on our website: <a href="https://www.fackelmann.co.in/contact"
                class="contact-link">https://www.fackelmann.co.in/contact</a></li>
    </ul>
</div>
