            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img data-desktop-src="assets/images/banners/sustainability/header-sustainability.webp"
                        data-mobile-src="assets/images/banners/sustainability/header-sustainability.webp"
                        alt="Banner 1">
                </div>
            </div>
    ...
    <section class="strategy sustainability-section-padding bcn-mintlight">
        <div class="container sustainability-container">
            <div class="title-wrapper pb-2">
                <h1 class="mega-title">
                    <span class="cn-mint">OUR STRATEGY: THREE PILLARS</span><br><span class="cn-mintdark">FOR
                        SUSTAINABLE
                        BUSINESS</span>
                </h1>
                <p class="info-p">Sustainable action is a matter of course for us. Many of our around 10,000 Fackelmann
                    ...
                    since our foundation around 100 years ago: Heinrich Fackelmann laid the foundation for this as early
                    as
                    1919 with the first wooden kitchen gadgets. Our goal: We want to convert a large part of our
                    products
            ...
            <div class="strategy-nav-panel" data-aos="fade-up">
                ...
                <div id="pills-home" class="tab-content active">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="strg-left">
                                <img src="assets/images/sustainability/icon-umwelt-mint.svg"
                        ...
                        <div class="col-md-8">
                            <p class="tab-detail">Deeply rooted in Germany and at home all over the world: This applies
                                equally to our products and their manufacture. At our headquarters in Hersbruck and
                                Aichach
                                in Bavaria, we set the highest standards in our production and on the most closed energy
                                and
                            ...
                            <p class="tab-detail">At our production sites around the world, we attach great importance
                                to
                                using the appropriate measures. The Hersbruck location has been climate-neutral since
                                2020,
                ...
                <div id="pills-profile" class="tab-content">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="strg-left">
                                <img src="assets/images/sustainability/icon-produkte-mint.svg"
                        ...
                        <div class="col-md-8">
                            <p class="tab-detail">As a manufacturer, we want our products to be as durable, resource-
                                and
                                energy-efficient as possible, as well as repair-friendly and recyclable. We always want
                                to
                                manufacture products for a long service life and pursue the ideal of circular economy.
                                That
                                is why we rely on materials without complex composition and easy to use. In order to
                                reduce
                            ...
                            <p class="tab-detail">Today we use PE made from renewable raw materials and FSC ™ certified
                                wood
                                for our “Ecolution” series. We are currently working on completely avoiding the use of
                                feed
                                plants for sustainable materials. We are also taking the first steps with baking molds:
                                With
                                our “Green Vision” baking molds, the wax from the Brazilian carnauba palm is being used
                                for
                ...
                <div id="pills-contact" class="tab-content">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <p class="tab-detail">Of course for us: As a family company, the company family is
                                particularly
                                important. Compliance with social standards and optimal working conditions for employees
                                as
                                well as creating a positive working atmosphere are the focus in Germany and at our more
                                than
                                40 company locations around the world. These standards are certified and approved both
                                by
                                ...
                                attach just as much importance to a balanced mix. 30% of our employees at the
                                headquarters
                                in Hersbruck are under 30 years of age, the average age is 42 years. In individual
                                employee
                                appraisals and regular feedback rounds, we jointly evaluate possible areas of
                                development in
                                order to continuously develop. We also support the “By bike to work” initiative,
                                subsidize
                                the use of public transport and promote company health management with various sports
                                and
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="sustainability-materials">
                            <h4>Green PE</h4>
                            <p class="materials-detail">Green PE is a natural plastic that is obtained from sugar cane
                                and
                                is used in kitchen
            ...
            <div class="material-card" data-aos="fade-up">
                <div class="row">
                    ...
                    <div class="col-md-6 order-sm-1">
                        <div class="sustainability-materials">
                            <h4>Ecolution</h4>
                            <p class="materials-detail">The products of the Ecolution series made from renewable PE and
                                FSC
                                ™ certified wood
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="sustainability-materials">
                            ...
                            <p class="materials-detail">FSC ™ is the abbreviation for Forest Stewardship Council ™, ie
                                the
                                promotion of
            ...
            <div class="material-card" data-aos="fade-up">
                <div class="row">
                    ...
                    <div class="col-md-6 order-sm-1">
                        <div class="sustainability-materials">
                            <h4>Carnauba wax</h4>
                            <p class="materials-detail">Baking molds have to withstand particularly high requirements:
                                They
                                have to be
