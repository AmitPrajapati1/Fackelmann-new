...
h1, h2, h3, h4, h5, p, .list-container p {
    color: #737373;
}
...
<div class="container my-5">
    <div class="privacy-container">
        ...
        <section>
            ...
            <h4 class="subsection-title">Interpretation</h4>
            ...
            <h4 class="subsection-title">Definitions</h4>
            <p>For the purposes of this Privacy Policy:</p>
            <div class="list-container">
                <p>Account means a unique account created for You to access our Service or parts of our Service.</p>
                <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Fackelmann Inda Kitchenware Pvt. Ltd., #315 - 3rd Floor, Part-II, JMD Pacific Square, Sector -15, Haryana, India.</p>
                ...
                <p>Country refers to: Haryana, India.</p>
                ...
                <p>Website refers to Fackelmann India, accessible from <a href="https://www.fackelmann.co.in" class="contact-link">Fackelmann.co.in</a>.</p>
                <p style="margin-bottom: 16px">You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
            </div>
        </section>

        <section>
            <h3>2. Collecting and Using Your Personal Data</h3>
            <h4 class="subsection-title">Types of Data Collected</h4>
            <h5>Personal Data</h5>
            ...
            <div class="list-container">
                <p><strong>Cookies or Browser Cookies:</strong> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent.</p>
                ...
                <p><strong>Web Beacons:</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons that permit the Company to count users who have visited those pages or opened an email.</p>
            </div>
            <p>We use both Session and Persistent Cookies for the following purposes:</p>
            <div class="list-container">
                <p><strong>Necessary / Essential Cookies:</strong> These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features.</p>
                <p><strong>Cookies Policy / Notice Acceptance Cookies:</strong> These Cookies identify if users have accepted the use of cookies on the Website.</p>
                <p><strong>Functionality Cookies:</strong> These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference.</p>
            </div>
        ...
        <section>
            ...
            <div class="list-container">
                ...
                <p>To manage Your Account: to manage Your registration as a user of the Service.</p>
                <p>For the performance of a contract: the development, compliance, and undertaking of the purchase contract for the products, items, or services You have purchased.</p>
                <p>To contact You: by email, telephone calls, SMS, or other equivalent forms of electronic communication.</p>
                <p>To provide You with news, special offers, and general information about other goods, services, and events.</p>
                <p>To manage Your requests: To attend and manage Your requests to Us.</p>
                <p>For business transfers: We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets.</p>
                <p>For other purposes: such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns, and to evaluate and improve our Service.</p>
            </div>
            <p>We may share Your personal information in the following situations:</p>
            <div class="list-container">
                <p>With Service Providers: to monitor and analyze the use of our Service, to contact You.</p>
                <p>For business transfers: in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition.</p>
                <p>With Affiliates: We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy.</p>
                <p>With business partners: to offer You certain products, services, or promotions.</p>
                <p>With other users: when You share personal information or otherwise interact in the public areas with other users.</p>
                <p style="margin-bottom: 16px">With Your consent: We may disclose Your personal information for any other purpose with Your consent.</p>
            </div>
        </section>
        ...
        <section>
            ...
            <h4 class="subsection-title">Business Transactions</h4>
            <p>If the Company is involved in a merger, acquisition, or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>

            <h4 class="subsection-title">Law Enforcement</h4>
            ...
            <h4 class="subsection-title">Other Legal Requirements</h4>
            ...
            <div class="list-container">
                ...
                <p style="margin-bottom: 16px">Protect against legal liability</p>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="list-container">
                <p>By visiting this page on our website: <a href="https://www.fackelmann.co.in/contact" class="contact-link">https://www.fackelmann.co.in/contact</a></p>
            </div>
        </section>
